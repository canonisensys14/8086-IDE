...
console.log(/WORD|W\./.test(operands[x]));
...
case "XCHG" :
    ...
    arr.push((mode<<6)+((regToId(operands[(/R/.test(operands[2]))?1:0]))<<3)+regmem);
    arr = byteConcat(str,arr);       
break;
case "LEA" :
...
case "CALL" :
    if(operands.length === 4)
    {
        ...
        {                
               ...
               // console.log("pppppppp "+convert(operands[0]));
                 arr.push(byte[0]);     
                 if (byte.length === 2) {
                     arr.push(byte[1]);
                 } else{arr.push(0);} 
...
var inst="div";
let testing=toBcode;
console.log(toBcode("mul w.[bx]"));
console.log(testing(inst+" "+"DX"));

console.log(testing(inst+" "+"5h"));
console.log(testing(inst+" "+"111111111b"));
console.log(testing(inst+" "+"[100H]"));
console.log(testing(inst+" "+"[bx]"));
console.log(testing(inst+" "+"[100H+di]"));
console.log(testing(inst+" "+"[bp]"));
console.log(testing(inst+" "+"es:[bx-300]"));
console.log(testing(inst+" "+"cx"));
console.log(testing(inst+" "+"11"));
console.log(testing(inst+" "+"300"));
console.log(testing(inst+" "+"100:-150"));
